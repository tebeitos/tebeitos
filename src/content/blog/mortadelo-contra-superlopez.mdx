...
<div class="my-6">
  <a href="https://www.amazon.es/s?k=mortadelo%20y%20filemon%20super%20humor&tag=tebeitos-21" target="_blank" rel="noopener noreferrer nofollow" class="boton-amazon group inline-flex items-center gap-2 font-fredoka text-base text-hueso bg-rojo px-6 py-3 border-3 border-negro shadow-comic hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all duration-100 relative no-underline" style="color: #FBF3E2; text-decoration: none;">
    <span>🛒</span>
    <span>Ver Mortadelo en Amazon</span>
  </a>
</div>
...
<div class="my-6">
  <a href="https://www.amazon.es/s?k=superlopez%20super%20humor&tag=tebeitos-21" target="_blank" rel="noopener noreferrer nofollow" class="boton-amazon group inline-flex items-center gap-2 font-fredoka text-base text-hueso bg-rojo px-6 py-3 border-3 border-negro shadow-comic hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all duration-100 relative no-underline" style="color: #FBF3E2; text-decoration: none;">
    <span>🛒</span>
    <span>Ver Superlópez en Amazon</span>
  </a>
</div>
